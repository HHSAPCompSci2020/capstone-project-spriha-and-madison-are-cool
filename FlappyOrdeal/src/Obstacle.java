...
public class Obstacle extends MovingImage {
	...
	public void draw(FlappyBirdGame app) {
		...
		//shiftOpening(1.5, (int) (Math.random() * (0.4*FlappyBirdGame.DRAWING_HEIGHT) + 0.1*FlappyBirdGame.DRAWING_HEIGHT), min + 300/*(int)(Math.random() * (0.4*FlappyBirdGame.DRAWING_HEIGHT) + 0.5)*/);
		shiftOpening();
		app.popStyle();
	}
}
